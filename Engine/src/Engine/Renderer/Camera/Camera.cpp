...
namespace VoxelEngine
{
	...
	Camera::Camera(float width, float height, float nearClip, float farClip, float fov)
	{
		m_projectionMatrix = glm::perspectiveFov(glm::radians(fov), width, height, farClip, nearClip);
	}
